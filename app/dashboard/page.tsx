    ...
    <div className="p-4 md:p-6">
      ...
      <div className="text-center mb-8">
        <div className="flex items-center justify-center mb-4">
          ...
          <h1 className="text-3xl font-bold text-slate-900 ml-3">Welcome to Groovi</h1>
        </div>
      ...
      {location && apiStatus?.success && (
        <div className="flex flex-wrap gap-2 mb-4">
          ...
          {filteredEvents.length > 0 && (
            <Badge variant="secondary" className="bg-blue-100 text-blue-700 text-xs flex items-center px-2 py-1">
      ...
      {/* Main Events Section */}
      <Card className="mb-6" id="events-section">
        <CardHeader>
          ...
          <CardDescription className="text-slate-600">
            {location ? "Live music events happening near you" : "Set your location below to search for local events"}
          </CardDescription>
        </CardHeader>
        <CardContent>
          {!location ? (
      ...
      <Card className="mb-6">
        <CardHeader>
          <CardTitle className="text-slate-900">Explore Your Scene</CardTitle>
          <CardDescription className="text-slate-600">
      ...
      {/* Location Settings */}
      <div id="location-settings" className="mb-6">
      ...
      {!location && (
        <Card className="border-dashed border-2 border-slate-300 bg-slate-50">
          <CardContent className="flex flex-col items-center justify-center p-8 text-center">
            ...
            <h3 className="text-lg font-semibold mb-2 text-slate-900">Get Started with Groovi</h3>
